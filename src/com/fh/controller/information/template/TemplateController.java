package com.fh.controller.information.template;
...
import com.fh.service.information.template.TemplateManager;
...
public class TemplateController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("information/template/template_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("information/template/template_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var2", varOList.get(i).getString("TEMPLATE_NAME"));	    //2
			vpd.put("var3", varOList.get(i).getString("ACCESS_DIR"));	    //3
			vpd.put("var4", varOList.get(i).getString("SELL_PRICE"));	    //4
			vpd.put("var5", varOList.get(i).getString("INDUSTRY_TYPE"));	    //5
			vpd.put("var6", varOList.get(i).getString("ORIGINAL_PRICE"));	    //6
			vpd.put("var7", varOList.get(i).getString("TEMPLATE_PICTURE"));	    //7
			vpd.put("var8", varOList.get(i).getString("CREATE_TIME"));	    //8
			vpd.put("var9", varOList.get(i).getString("MODIFY_TIEM"));	    //9
			vpd.put("var10", varOList.get(i).getString("RECORD_STATUS"));	    //10
			varList.add(vpd);
		}
